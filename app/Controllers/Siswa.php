...
class Siswa extends BaseController
{
	...
	public function simpanSiswa(){
		...
		if(count($siswa) == 1){
			return redirect()->to('/siswa')->with('pesan-error','<div class="alert alert-danger"><span class="font-weight-bold">Perhatian :</span>NISN sudah ada</div>');
		}else{
	...
	public function dashboardSiswa(){
		...
		<b>"Hallo '.session()->get('nama').'" <p>Gunakaan Halamain Ini Untuk Melihat History Pembayaran Spp Andaa</b>
		<p style="font-family: Times New Roman; font-size: 14px; color: black></p>
	  </div>';
