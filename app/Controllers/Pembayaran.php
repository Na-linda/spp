...
class Pembayaran extends BaseController
{
	...
	public function simpanBayar(){
		...
		{
			return redirect()->to('/bayar')->with('pesan','<div class="alert alert-danger"><span class="font-weight-bold">Perhatian :</span> Terjadi kelebihan pembayaran '.($lebihBayar).'</div>'); 
			...
			$dataPembayaran=[
				...
				'bulan_bayar'	=> $this->request->getPost('txtBulan'),
				'tahun_bayar'	=> date('Y'),
