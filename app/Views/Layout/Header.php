...
<html lang="en" class="h-100">
  <head>
    ...
    <meta name="description" content="Aplikasi Pembayaran">
  ...
  <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-primary">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="/petugas/logout" data-confirm="Anda yakin ingin keluar?"><i class="fas fa-sign-out-alt"></i> Logout</a>
        </li>        
