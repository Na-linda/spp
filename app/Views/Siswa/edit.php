...
<div class="form-group">
    ...
    <input type="text" value="<?=$detailSiswa[0]['nis'];?>" name="txtInputNis" class="form-control" placholder="Masukan NIS anda" autocomplete="off" required/>
</div>

<div class="form-group">
    <label class="font-weight-bold">Nama Lengkap</label>
    <input type="text" value="<?=$detailSiswa[0]['nama'];?>" name="txtInputNama" class="form-control" placholder="Masukan Nama Anda" autocomplete="off" required/>
</div>
